...
@Configuration
@EnableJpaRepositories(basePackages = "com.example.sprint2.repositories", entityManagerFactoryRef = "entityManagerFactory",
                       transactionManagerRef = "transactionManager")
@EntityScan("com.example.sprint2.*")
public class EntityManagerConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.sprint2.model");
