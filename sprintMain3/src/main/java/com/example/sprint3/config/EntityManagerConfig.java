...
@Configuration
@EnableJpaRepositories(basePackages = "com.example.sprint3.repositories", entityManagerFactoryRef = "entityManagerFactory",
                       transactionManagerRef = "transactionManager")
@EntityScan("com.example.sprint3.*")
public class EntityManagerConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.sprint3.model");
